...
UI_TEXTS = {
    "start_menu": (
        ...
        "{Buy_now} Buy now : 🛍️ Buy Now : All Key Purchase & Instant Delivery\n"
        "{Check_update} 📢 Check Update : Check Setup Video And Update Apk\n"
        "{add_balance} 🪙 Add Balance : Deposit Balance & Secure Auto-Add Payment System\n"
        "{My_profile+All_History} 𝗔𝗹𝗹 𝗵𝗶𝘀𝘁𝗼𝗿𝘆 : 🆔 My Profile + All History : Check Your Account Information + All History\n"
        "{Refer_And_Earn} 👥 Refer And Earn : Share Refer Link & Earn Money\n"
        "{How_to_use} 🎬How To Use Bot : View Tutorial And Work This Bot\n"
    ),
    "vip_menu": (
